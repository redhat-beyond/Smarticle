import pytest
from projboard.models.models import User, Article, Like, View, Subject
...
class TestArticle:
    ...
    def like(self, user, art):
        return Like(user_id=user, article_id=art)

    @pytest.fixture
    def view(self, user, art):
        return View(user_id=user, article_id=art)
    ...
    def test_filterObjects(self, sup, sup1, user, art, user1, art1, like, view):
        ...
        art1.save()
        # Filter By Likes
        print(Article.filterByLikes())
        # Filter By Views
        print(Article.filterByViews())
        assert True

    # @pytest.mark.skip
    @pytest.mark.django_db
    def test_getNumOfFuntions(self, sup, sup1, user, user1, art1, art, like, view):
        sup.save()
        sup1.save()
        user.save()
        art.save()
        ...
        assert 1 == art.numOfViews()
        assert 0 == art1.numOfViews()
